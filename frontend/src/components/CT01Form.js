...
/**
 * CT01Form
 * - An toàn với props rỗng/undefined
 * - Tự động map dữ liệu từ CCCD (personName, idCode, dateOfBirth, gender, residencePlace)
 * - Hỗ trợ template động (text, textarea, select, date, number, email, array, table)
 * - Kiểm tra các field required theo template trước khi submit
 * - Expose handleSubmit qua ref (parent có thể gọi formRef.current.handleSubmit())
 */
